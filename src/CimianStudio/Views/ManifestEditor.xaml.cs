...
using ContextOption = CimianStudio.Views.ContextualChipList.ContextOption;
using ChipEntry = CimianStudio.Views.ContextualChipList.ChipEntry;
...
public sealed partial class ManifestEditor : UserControl
{
    ...
    private void BuildCatalogChecklist(IReadOnlyCollection<string>? selected)
    {
        ...
        foreach (var name in CimianStudio.Models.CatalogOrdering.Sort(union))
        {
