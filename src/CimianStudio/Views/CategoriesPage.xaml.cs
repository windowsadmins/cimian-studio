...
public sealed partial class CategoriesPage : Page
{
    ...
    private void OnViewModelPropertyChanged(object? sender, PropertyChangedEventArgs e)
    {
        ...
        {
            case nameof(CategoriesViewModel.Categories):
                RefreshHeader();
                break;
            case nameof(CategoriesViewModel.SelectedCategory):
                RefreshDetail();
                break;
        }
    }
    ...
    {
        CountText.Text = string.Create(CultureInfo.InvariantCulture, $"({ViewModel.Categories.Count})");
    }
